class UserMailer < ApplicationMailer
  ...
  def welcome_email(user)
    ...
    @url  = 'https://eventproject-mardi-kubitus.herokuapp.com/' # <= page d'accueil mon site, à modifier vers une page 'login'
  ...
  def admin_booking_email(attendance) 
    ...
    @url  = 'https://eventproject-mardi-kubitus.herokuapp.com/'
